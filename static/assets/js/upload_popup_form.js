        ...
        <div class="h-auto w-96 bg-white video_playback opacity-100 absolute top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] overflow-hidden rounded-2xl">
            ...
            <div class="w-full p-2 flex flex-col items-center">
              <div class="w-full h-auto p-1">
                ...
                <div class="w-full flex">
                  <div class="w-1/4 flex items-center select-none text-xs">Cover Picture</div>
                  <div class="w-3/4">

                    <div class="cover_picture_view w-full flex justify-center items-center flex-col"></div>

                    <input type="file" name="file-input" class="cover_picture block my-2 w-full bg-slate-100 border border-gray-200 shadow-sm rounded-lg text-xs focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 file:bg-gray-50 file:border-0 file:bg-gray-100 file:me-4 file:py-3 file:px-4 dark:file:bg-gray-700 dark:file:text-gray-400">
                  </div>
                </div>

                <div class="w-full flex">
                  <div class="w-1/4 flex items-center select-none text-xs">Source</div>
                  <div class="w-3/4">
                    <input type="checkbox" id="yt_video" name="file-input" class="my-1 self-start"><label for="yt_video" class="mx-2 text-slate-700 select-none text-xs cursor-pointer">Youtube Link Upload</label>
                  </div>
                </div>
                ...
                <div class="w-full flex">
                  ...
                  <div class="w-3/4">
                    ...
                    <input type="file" name="file-input" class="video_link file block my-1 w-full bg-slate-100 border border-gray-200 shadow-sm rounded-lg text-xs focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 file:bg-gray-50 file:border-0 file:bg-gray-100 file:me-4 file:py-3 file:px-4 dark:file:bg-gray-700 dark:file:text-gray-400">

                    <input type="text" class="youtube_link title hidden py-3 px-4 block my-1 w-full border-gray-200 rounded-lg text-xs focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Youtube Link" required>
                  </div>
                </div>
